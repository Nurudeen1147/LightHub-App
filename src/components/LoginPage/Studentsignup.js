...
export default function Studentsignup() {
  ...
  const handleSubmit = (event) => {
    ...
    // Update the profileData state with the submitted values
    setProfileData({
      firstName: data.get('firstName'),
      lastName: data.get('lastName'),
      email: data.get('email'),
  ...
  return (
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <FormControlLabel
                  ...
                  label="I want to receive latest ebooks and updates via email."
                />
              </Grid>
            </Grid>
            <Button
    ...
    <ProfileUpdate
        ...
        handleClose={handleProfileUpdateClose}
